...
This is a fork of [korthout/backport-action](https://github.com/korthout/backport-action).
...
Please open an [issue on GitHub](https://github.com/kosarko/backport-action/issues).

## Docs changes

Saw a typo or want to make other changes to the [README](https://kosarko.github.io/backport-action/blob/main/README.md)?
...
To release a version, run the [Release](https://github.com/kosarko/backport-action/actions/workflows/release.yml) workflow from the branch that should be released.
